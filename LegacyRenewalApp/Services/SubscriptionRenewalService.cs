...
namespace LegacyRenewalApp
{
    public class SubscriptionRenewalService
    {
        ...
        /// <summary>
        /// Konstruktor domyślny podtrzymujący wsteczną kompatybilność kontraktu.
        /// Użycie wzorca "Poor Man's DI" (zależności na sztywno) by zapobiec modyfikacjom zewnętrznych konsumentów.
        /// </summary>
